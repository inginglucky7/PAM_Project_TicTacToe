        ...
        <div className="bg-kiddobg w-screen h-screen bg-center relative">
            ...
            <div className="flex justify-center">
                <div className="absolute mt-[42%]">
                    <button className="font-bold text-5xl block w-[300px] h-[100px] rounded-t-3xl bg-kiddoyellow hover:bg-kiddoyellowhover mx-auto drop-shadow-kiddodropshadow">LOGIN</button>
                    <br />
                    <button className="font-bold text-3xl block w-[400px] h-[75px] rounded-t-3xl bg-kiddoyellow hover:bg-kiddoyellowhover drop-shadow-kiddodropshadow">CREATE AN ACCOUNT</button>
                </div>
            </div>
